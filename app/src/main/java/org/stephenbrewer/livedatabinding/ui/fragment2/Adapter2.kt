...
package org.stephenbrewer.livedatabinding.ui.fragment2
...
import org.stephenbrewer.livedatabinding.databinding.RecyclerView2Binding
...
class Adapter2(
    ...
    class ViewHolder2(
        val binding: RecyclerView2Binding
    ): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder2 {
        val layoutInflater = LayoutInflater.from(parent.context)
        val binding = RecyclerView2Binding.inflate(layoutInflater, parent, false)
        val viewHolder = ViewHolder2(binding)
        binding.lifecycleOwner = lifecycleOwner
        binding.itemModel = ItemModel(parent.context, "Adapter2")
    ...
    private val asyncListDiffer = AsyncListDiffer<Long>(this@Adapter2, LongDiffCallback())
