...
class Fragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = Adapter2(viewLifecycleOwner)
        ...
        recycler_view_2.adapter = adapter
        recycler_view_2.layoutManager = LinearLayoutManager(requireContext())
    }

    override fun onDestroyView() {
        recycler_view_2.adapter = null
        super.onDestroyView()
    }
}
